            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <label className="flex items-center p-4 border rounded-lg cursor-pointer transition-all" 
                  ...
                  />
                  <div>
                    <div className="font-semibold" style={{ color: 'var(--text-primary)' }}>2-min pulse</div>
                    <div style={{ color: 'var(--text-secondary)', fontSize: '14px' }}>Quick feedback, 3-5 questions</div>
                  </div>
                </label>
                <label className="flex items-center p-4 border rounded-lg cursor-pointer transition-all"
                       style={{ 
                  ...
                  />
                  <div>
                    <div className="font-semibold" style={{ color: 'var(--text-primary)' }}>15-min deep dive</div>
                    <div style={{ color: 'var(--text-secondary)', fontSize: '14px' }}>Comprehensive, 10-15 questions</div>
                  </div>
                </label>
              </div>
            </div>
