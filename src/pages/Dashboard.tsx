...
const Dashboard: React.FC = () => {
  ...
  const [filter, setFilter] = useState<"all" | "active" | "draft" | "closed">(
    "all"
  );
          ...
          <div className="lg:col-span-2">
            <div className="professional-card">
                  ...
                  <div className="flex items-center justify-between w-full ">
                    ...
                    <div className="flex items-center justify-between sm:justify-end gap-2">
                      ...
                      <div className="hidden sm:flex gap-2">
                        {["All", "Active", "Draft", "Closed"].map((option) => (
                          <button
                            key={option}
                            onClick={() =>
                              setFilter(option.toLowerCase() as any)
                            }
                            style={{
                              backgroundColor:
                      ...
                      <div className="relative sm:hidden ml-auto">
                        ...
                        {mobileMenuOpen && (
                          <div
                            className="absolute right-0 z-10 mt-2 w-40 rounded shadow-lg border"
                            style={{
              ...
              <div className="divide-y divide-border">
                {surveys
                  .filter(
                    (survey) => filter === "all" || survey.status === filter
                  )
                  .map((survey) => (
                    <div
                      key={survey.id}
                      ...
                      <div className="flex-col md:flex-row flex gap-4 justify-between">
                        <div className="flex-1">
                          <div className="flex flex-col-reverse gap-2 sm:flex-row space-x-3">
                            ...
                            <div className="flex justify-end">
                              <span
                                className={`status-badge status-${survey.status} flex space-x-1`}
                              >
